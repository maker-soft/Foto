...
(function(){
  ...
  async function handleAction(b){
    ...
    if(action==='add-album')d.albums.push({id:uid(currentDirection),title:'Новый альбом',subtitle:'',text:'',cover:'',gallery:[]});
